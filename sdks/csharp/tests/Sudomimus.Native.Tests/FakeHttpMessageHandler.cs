...
/// and records each outgoing request (with body pre-buffered so tests can
/// read it after the request has been disposed by HttpClient).
/// </summary>
internal sealed class FakeHttpMessageHandler : HttpMessageHandler
{
    ...
    {
        // Read the body NOW because HttpClient will dispose the request
        // (and its Content stream) as soon as our caller finishes.
